    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 8, 9, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Beast XYZ", 5, 36, 12.5f },
                    { 2, new DateTime(2026, 4, 15, 13, 30, 0, 0, DateTimeKind.Unspecified), "Office Mini Pro", 12, 24, 4.2f },
                    { 3, new DateTime(2026, 3, 10, 10, 0, 0, 0, DateTimeKind.Unspecified), "Budget Home PC", 8, 12, 6.8f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU001", 1, 1, "High-end gaming processor", "Intel i9" },
                    { "GPU001", 3, 2, "High-performance graphics card", "RTX 4090" },
                    { "RAM001", 2, 3, "DDR5 RAM kit", "Corsair 32GB" }
                });
